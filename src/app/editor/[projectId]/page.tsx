        ...
        <div className="flex-1 overflow-y-auto p-5 custom-scrollbar">
          ...
          <div className="space-y-1.5 mb-10">
            <button
              ...
              className={`w-full text-left px-3.5 py-2.5 rounded-xl text-sm transition-all duration-200 border mb-2 ${activeSceneId === 'characters-arc'
            ...
            {scenes.map((scene) => (
              <button
                ...
                className={`w-full text-left px-3.5 py-2.5 rounded-xl text-sm transition-all duration-200 border ${activeSceneId === scene.id
              ...
              {characters.map((c) => (
                <div key={c.id} className="flex flex-col p-3.5 rounded-xl bg-black/20 border border-white/5 shadow-inner">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className={`text-[10px] px-2 py-0.5 rounded-full font-medium ${c.role_tag === "Main" ? "bg-purple-500/20 text-purple-300 border border-purple-500/30" :
